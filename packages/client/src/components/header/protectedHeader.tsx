...
export const ProtectedHeader = component$(() => {
  ...
  return (
    <Speak assets={["header"]}>
      <nav class="px-2 bg-slate-400 border-gray-200 dark:bg-black dark:border-gray-700">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
          <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-slate-400 md:flex-row md:space-x-8 md:mt-0 md:text-md md:font-medium md:border-0 dark:text-white hover:text-blue-700 md:bg-slate-400 dark:hover:text-blue-500 dark:bg-black md:dark:bg-black dark:border-gray-700">
            <li>
              <a
                role="button"
